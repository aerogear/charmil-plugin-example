...
Once pushed, a [GitHub Action](https://github.com/aerogear/charmil-plugin-example/actions/workflows/release.yml) will create a release on GitHub and upload the binaries.
...
Run `./scripts/generate-changelog.sh` to output the changes between the current and last stable releases. Paste the output into the description of the [release on GitHub](https://github.com/aerogear/charmil-plugin-example/releases/tag/latest).
