...
import (
	"github.com/aerogear/charmil-plugin-example/pkg/cmd/completion/bash"
	"github.com/aerogear/charmil-plugin-example/pkg/cmd/completion/fish"
	"github.com/aerogear/charmil-plugin-example/pkg/cmd/completion/zsh"
