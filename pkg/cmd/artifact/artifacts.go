...
import (
	"github.com/aerogear/charmil-plugin-example/pkg/cmd/artifact/crud/create"
	"github.com/aerogear/charmil-plugin-example/pkg/cmd/artifact/crud/delete"
	"github.com/aerogear/charmil-plugin-example/pkg/cmd/artifact/crud/get"
	"github.com/aerogear/charmil-plugin-example/pkg/cmd/artifact/crud/list"
	"github.com/aerogear/charmil-plugin-example/pkg/cmd/artifact/crud/update"
	"github.com/aerogear/charmil-plugin-example/pkg/cmd/artifact/download"
	"github.com/aerogear/charmil-plugin-example/pkg/cmd/artifact/metadata"
	"github.com/aerogear/charmil-plugin-example/pkg/cmd/artifact/versions"
